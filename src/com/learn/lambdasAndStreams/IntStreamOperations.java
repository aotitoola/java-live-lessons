package com.learn.lambdasAndStreams;
...
public class IntStreamOperations {
    ...
    public static void main(String[] args) {
        ...
        IntStream.of(values).forEach((int value) -> System.out.printf("%s ", (String.valueOf(value))));
        System.out.println();

        // count, min, max, sum and average of the values; //TERMINAL OPERATIONS
        ...
        System.out.printf("%nSum of squares via reduce method: %d%n", IntStream.of(values).reduce(0, (x, y) -> x + y * y));
